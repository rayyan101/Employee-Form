...
<h2>Employee Form</h2>
  <form method="POST" enctype="multipart/form-data">
	...
	<input type="checkbox" id="mode" <?php if ( $res[0]->checking == 'on' ) { ?> checked  <?php } ?> name="mode"style="margin:9px;"><b>Enable If Designation is Developer</b>
	</div>
	<div class="row">
	<div class="col-25">
  ...
  <input type="range" id="skills" style="width:300px;" name="rangeInput" min="0" max="100" onchange="updateTextInput(this.value);" required>
	...
	<div class="col-75">
		<input type="radio" id="gender" name="gender" <?php if ( $res[0]->gender == 'male' ) { ?> checked  <?php } ?> checked value="male">Male
		<input type="radio" id="gender" name="gender" <?php if ( $res[0]->gender == 'female' ) { ?> checked  <?php } ?> value="female">female </div>
	</div>
	<?php if ( $res == '' ) { ?>
	<div class="row">
